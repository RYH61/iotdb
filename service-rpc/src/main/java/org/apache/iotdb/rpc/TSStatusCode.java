...
public enum TSStatusCode {
  ...
  // Quota
  SPACE_QUOTA_EXCEEDED(1500),
  NUM_REQUESTS_EXCEEDED(1501),
  REQUEST_SIZE_EXCEEDED(1502),
  NUM_READ_REQUESTS_EXCEEDED(1503),
  NUM_WRITE_REQUESTS_EXCEEDED(1504),
  WRITE_SIZE_EXCEEDED(1505),
  READ_SIZE_EXCEEDED(1506);
